(function () {
  ...
  var pickerBtns = Array.prototype.slice.call(document.querySelectorAll('.demo-picker button[data-src]'));
  ...
  // Panel picker: toggles visibility of content panels (e.g. sketch views).
  document.querySelectorAll('.panel-picker').forEach(function (picker) {
    var btns = Array.prototype.slice.call(picker.querySelectorAll('button[data-panel]'));
  ...
  // GT label carousel: prev/next buttons cycle through slides.
  document.querySelectorAll('.gt-carousel').forEach(function (carousel) {
    var slides = Array.prototype.slice.call(carousel.querySelectorAll('.gt-carousel-slide'));
    if (!slides.length) return;
    var prevBtn = carousel.querySelector('.gt-carousel-prev');
    var nextBtn = carousel.querySelector('.gt-carousel-next');
    var current = 0;
  ...
  try {
    ...
    if (page) localStorage.setItem('xmind.lang', page.startsWith('zh') ? 'zh' : 'en');
